...
/**
 * struct data - The Entry Point.
 * Description - struct that contains all relevant data on runtime.
 * @av: argument vector.
...
/**
 * struct sep_list_s - The Entry Point.
...
/**
 * struct line_list_s - The Entry Point.
 * Description - the single linked list.
...
/**
 * struct r_var_list - The Entry Point.
 * Description - the single linked list.
...
/**
 * struct builtin_s - The Entry Point.
 * Description - Builtin struct for command args.
